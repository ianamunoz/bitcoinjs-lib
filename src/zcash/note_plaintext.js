...
NotePlaintext.prototype.note = function (a_pk) {
  return new Note(a_pk, this.value, this.rho, this.r)
}

NotePlaintext.prototype.encrypt = function (encryptor, pk_enc) {
  return encryptor.encrypt(pk_enc, this.toBuffer())
}
